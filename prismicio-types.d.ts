...
interface SettingsDocumentData {
  /**
   * myName field in *Settings*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.myname
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  myname: prismic.KeyTextField;
...
/**
 * Primary content in *YoutubeBlock → Primary*
 */
export interface ImageBlockSliceDefaultPrimary {
  /**
   * Youtube Video ID field in *YoutubeBlock → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: ectK37oRq7c
   * - **API ID Path**: image_block.primary.youtube_video_id
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  youtube_video_id: prismic.KeyTextField;

  /**
   * Thumbnail Override field in *YoutubeBlock → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: image_block.primary.thumbnail_override
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
/**
 * Default variation for YoutubeBlock Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
...
/**
 * Slice variation for *YoutubeBlock*
 */
type ImageBlockSliceVariation = ImageBlockSliceDefault;

/**
 * YoutubeBlock Shared Slice
 *
 * - **API ID**: `image_block`
